...
def process_heuristics(df, main_col, sub_col):
    ...
    # [双重保险] 强制再检查一遍熟食，防止被海鲜/肉类覆盖
    # 因为 ordered_checks 虽然排了序，但 mask 逻辑复杂，直接覆盖最稳妥
...
def main():
    print(f"{bcolors.BOLD}=== Moze 导入工具 v10.97 (诚实修正版) ==={bcolors.ENDC}")
    try:
