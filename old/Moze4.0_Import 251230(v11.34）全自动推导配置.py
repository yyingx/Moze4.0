...
DATA_SOURCE = {
    ...
    'VEGETABLE': [
        ...
        "白菜", "菠菜","上海青", "油麦菜", "生菜", "娃娃菜", "空心菜", "苋菜", "菜芯", "韭菜", "香菜", "芹菜", "荠菜", "芥蓝",
         # 根茎类
        "土豆", "胡萝卜", "白萝卜", "青萝卜", "红薯", "紫薯", "山药", "芋头", "莲藕",  "藕","洋葱", "大蒜", "生姜", "竹笋", "芦笋", "茭白",
         # 茄果/瓜果类
...
def main():
    print(f"{bcolors.BOLD}=== Moze 导入工具 v11.34 (纯净排序优化版) ==={bcolors.ENDC}")
    try:
