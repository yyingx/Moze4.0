...
def process_transactions(df_source, df_rules, start_datetime_obj):
    ...
    df_target.loc[condition_mask & breakfast_mask & is_expense_mask, ['主类别', '子类别', '项目']] = ['饮食', '早餐', '食']
    df_target.loc[condition_mask & lunch_mask & is_expense_mask, ['主类别', '子类别', '项目']] = ['饮食', '午餐', '食']
    df_target.loc[condition_mask & dinner_mask & is_expense_mask, ['主类别', '子类别', '项目']] = ['饮食', '晚餐', '食']
    df_target.loc[condition_mask & MidnightSnack_mask & is_expense_mask, ['主类别', '子类别', '项目']] = ['饮食', '夜宵', '食']
