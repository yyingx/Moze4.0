...
DATA_SOURCE = {
    ...
    'DAILY_NECESSITIES': [
        ...
        "雨伞", "锁", "蚊香", "香薰", "电池", "螺丝刀", "卷尺", "润滑油", "胶水", "插座", "理线器"
    ],
    'BAD_SHOP': [
...
def main():
    print(f"{bcolors.BOLD}=== Moze 导入工具 v10.49 (逻辑严格复原版) ==={bcolors.ENDC}")
    try:
